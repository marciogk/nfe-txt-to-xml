...
st.markdown(
    """
    **Instruções:**
    1. Selecione um arquivo .txt de NF-e clicando no botão <span style="color:yellow;">Browse files</span>.
    2. Verifique o conteúdo do arquivo.
    3. Clique no botão <span style="color:yellow;">Converter para .xml</span>.
